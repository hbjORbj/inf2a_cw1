...
class MH_Parser extends GenParser implements PARSER {
    ...
    String[] tableEntry (String nonterm, String tokClass) {
      if (nonterm.equals("#Prog")) {
          ...
          if (tokClass.equals("VAR") || tokClass.equals("(") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")) return Exp0 ;
          else if (tokClass.equals("if")) return if_then_else;
          else return null ;
      }
      else if (nonterm.equals("#Exp0")) {
          if (tokClass.equals("VAR") || tokClass.equals("(") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")) return Exp1_Rest0 ;
          else return null ;
      }
          ...
          if (tokClass.equals("VAR") || tokClass.equals("(") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")) return Exp2_Rest1 ;
          else return null ;
      }
          ...
          if (tokClass.equals("VAR") || tokClass.equals("(") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")) return Exp3_Rest2 ;
          else return null ;
      }
      else if (nonterm.equals("#Rest2")) {
          if (tokClass.equals(";") || tokClass.equals("+") || tokClass.equals("-") || tokClass.equals("then") || tokClass.equals("else") || tokClass.equals(")") || tokClass.equals("==") || tokClass.equals("<=")) return epsilon ;
          else if (tokClass.equals("VAR") || tokClass.equals("(") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")) return Exp3_Rest2;
          else return null ;
      }
